...
extern PRECISION vec2 hedonia_shader_blackout;
...
vec4 effect(vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords)
{
    ...
    colour.r = hedonia_shader_blackout.x; // we are required to use the variable hedonia_shader_blackout in the code somewhere.
    vec4 tex = Texel(texture, texture_coords);
    vec4 final = vec4(0,min(0,0-hedonia_shader_blackout.x),0,tex.a);
